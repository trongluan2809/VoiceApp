...
public class CircleImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int size = (int) (mBorderRadius * 2 + mShadowSize * 2);
        ...
        if (mBorderWidth > 0) {
            tmp.drawCircle(mBorderRect.centerX(), mBorderRect.centerY(), mBorderRadius - mShadowSize, mBorderPaint);
        }
        if (mFillColor != Color.TRANSPARENT) {
            tmp.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), mDrawableRadius - mShadowSize, mFillPaint);
        }
        tmp.drawCircle(mDrawableRect.centerX(), mDrawableRect.centerY(), mDrawableRadius - mBorderWidth - mShadowSize, mBitmapPaint);
