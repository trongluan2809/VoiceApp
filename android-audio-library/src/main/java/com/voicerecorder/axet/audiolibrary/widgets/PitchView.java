...
public class PitchView extends ViewGroup {
    ...
    // pitch length in dp
    public static final float PITCH_WIDTH = .5f;
...
//
            // Set custom font for text displaying decibel
...
//        pitchDelimiter = ThemeUtils.dp2px(getContext(), PITCH_DELIMITER);
        // Remove distance between pitches
        pitchDelimiter = 0;

        pitchWidth = ThemeUtils.dp2px(getContext(), PITCH_WIDTH);
        pitchSize = pitchWidth + pitchDelimiter;
